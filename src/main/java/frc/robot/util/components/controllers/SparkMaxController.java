...
//   // private final SparkClosedLoopController closedLoopSpark;
...
//     // closedLoopSpark = sparkMaxes[0].getClosedLoopController();
...
//         sparkMaxes[i].configure(config.baseSparkConfig, config.revResetMode,
// config.revPersistMode);
//       } else {
//         sparkMaxes[i].configure(config.sparkConfigs[i], config.revResetMode,
// config.revPersistMode);
//       }
//       if (config.useAlternateEncoder) {
//         // sparkMaxes[i].configure(new AlternateEncoderConfig().setSparkMaxDataPortConfig(),
// null,
//         // null)
...
//   // public void setInput(Pos_State V_State) {
//   //   closedLoopSpark.setSetpoint();
//   // }
