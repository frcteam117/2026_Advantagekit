...
//   private final SingleJointedArmSimCopy sim;
...
//           * config.moi_kgm2
//           / config
//               .mass_kg); // SingleJointedArmSim assumes J=1/3 mL² -> L=(3J/m)^½, m=mass,
// L=length,
//       // J=moi
//     }
...
//     sim = new SingleJointedArmSimCopy(
//         LinearSystemId.createSingleJointedArmSystem(
//             config.gearbox, config.moi_kgm2, config.reduction),
//         config.gearbox,
//         config.reduction,
//         config.length_m,
//         config.min_Pos.pos(Radians) + config.cmOffset_rad,
//         config.max_Pos.pos(Radians) + config.cmOffset_rad,
//         true,
//         ((Pos_State) config.start_State).pos(Radians) + config.cmOffset_rad);
//   }
...
//     sim.setState(new_State.pos(Radians), new_State.vel(RadiansPerSecond));
//   }

//   public void resetState(Pos_State new_State) {
//     sim.setState(new_State.pos(Radians), sim.getVelocityRadPerSec());
//   }

//   public void resetState(Vel_State new_State) {
//     sim.setState(sim.getAngleRads(), new_State.vel(RadiansPerSecond));
//   }
...
//   public static class SingleJointedArmSimCopy extends LinearSystemSim<N2, N1, N2> {
...
//      *
//      * @param plant The linear system that represents the arm. This system can be created with
// {@link
...
//     public SingleJointedArmSimCopy(
...
//     /**
//      * Sets the arm's state. The new angle will be limited between the minimum and maximum
// allowed
//      * limits.
//      *
...
//       setState(
//           VecBuilder.fill(MathUtil.clamp(angleRadians, m_minAngle, m_maxAngle),
// velocityRadPerSec));
//     }
