...
// public class RecordStruct implements Struct {
...
//   public RecordStruct(Class<?> recordClass, Unit... units) {
//     this(recordClass, recordClass.getSimpleName(), units);
//   }

//   @SuppressWarnings("unchecked")
//   public RecordStruct(Class<?> recordClass, String typeName, Unit... units) {
...
//       } else if (Measure.class.isAssignableFrom(component.getType())) {
//         // Unit tempUnit = null;
//         // if (units.length > num) {
//         //   tempUnit = units[num];
//         // } else {
...
//         size += 8;
//         schema.append("double ");
//         schema.append(component.getName() + LogUtil.toSuffix(unit.symbol()));
//         num++;
//         schema.append(";");
//         packFunctions.add((ByteBuffer bb, Object record) -> {
//           try {
//             bb.putDouble((double) ((Measure) accessor.invoke(record)).in(unit));
//           } catch (IllegalAccessException
//               | IllegalArgumentException
//               | InvocationTargetException e) {
//             e.printStackTrace();
...
//                 + "\" for record type \""
//                 + recordClass.getSimpleName()
//                 + "\" uses an unsupported type and will not be logged. Check the AdvantageKit
// documentation for details on record logging.",
//             true);
//         packFunctions.add((ByteBuffer bb, Object record) -> {});
//         unpackFunctions.add((ByteBuffer bb) -> null);
//       }
